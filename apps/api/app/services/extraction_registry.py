...
_SECTION_PROFILE_RULES: list[tuple[str, ExtractionProfile]] = [
    ...
    ("orientações e supervisões concluídas", "orientacoes"),
    ("orientacoes e supervisoes concluidas", "orientacoes"),
    ("orientações e supervisões em andamento", "orientacoes"),
    ("orientacoes e supervisoes em andamento", "orientacoes"),
