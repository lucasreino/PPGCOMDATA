...
def import_lattes_xml(
    ...
    formacao_root = root.find("FORMACAO-ACADEMICA-TITULACAO")
...
def _import_projetos(
    ...
    for proj in atuacoes.findall(".//PROJETO-DE-PESQUISA"):
        titulo = _attr(proj, "TITULO-DO-PROJETO")
        if not titulo:
            continue
        ...
        descricao = _attr(desc_el, "DESCRICAO-DO-PROJETO") if desc_el is not None else ""
