...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-[#0b0f19]">
      <div className="w-full max-w-md glow-card rounded-2xl p-8 border border-slate-800">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="mt-1 w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-slate-200"
              required
            />
          </div>
          <div>
          ...
          <button
            ...
            className="w-full py-2.5 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-white text-sm font-bold rounded-lg transition-colors"
          >
