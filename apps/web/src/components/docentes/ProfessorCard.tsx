...
export function ProfessorCard({ prof }: { prof: ProfessorCatalog }) {
  ...
  return (
    <Link
      ...
      className="glow-card group rounded-2xl p-5 border border-slate-200 hover:border-indigo-300 hover:shadow-lg hover:shadow-indigo-100 transition-all duration-300 flex flex-col"
    >
      ...
      <div className="grid grid-cols-2 gap-2 mt-4 pt-4 border-t border-slate-200 text-[10px]">
      ...
      <div className="mt-4 flex items-center justify-center gap-1 text-[11px] font-semibold text-indigo-600 group-hover:text-indigo-700">
        Ver perfil completo
